#ifndef _ENGINE_CROSS_H_
#define _ENGINE_CROSS_H_

#include "DXEngine.h"

class EngineCross : DXEngine {
 private:
  enum AddressMode {
 ...
 protected:
 public:
 EngineCross() : DXEngine() {};
 EngineCross(Args *args, long beg, long end, long mask, const char *file) : DXEngine(args, beg, end, mask, file) {};
